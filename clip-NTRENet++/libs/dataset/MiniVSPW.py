...
class MiniVSPWDataset(Dataset):
    def __init__(self, data_path=None, train=True, valid=False,
                 ...
                 transforms=None, another_transform=None, who='nkp'):
        self.train = train
        self.valid = valid
        ...
        if who not in ['nkp', 'nian']:
            raise RuntimeError("args.who should be nkp or nian]")
        data_path = '/disk2/lyw/datasets'
...
if __name__ == "__main__":
    ytvos = MiniVSPWDataset(train=True, query_frame=5, support_frame=5)
