...
class PSPnet(nn.Module):
    def __init__(self, out_channels=256):
        ...
        self.down_dim = nn.Sequential(
            nn.Conv2d(out_channels*5, out_channels, kernel_size=1, padding=0, bias=False),
    ...
    def forward(self, x):
        ...
        out = torch.cat([global_feature, self.layer6_1(x), self.layer6_2(x), self.layer6_3(x), self.layer6_4(x)],1)
        return self.down_dim(out)
